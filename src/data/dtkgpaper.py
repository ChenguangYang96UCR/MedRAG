...
if __name__ == "__main__":
    ...
    fdir = "/home/cyang314/DtRAG/raw_txt"
    fnames = sorted(os.listdir(fdir))

    if not os.path.exists("corpus/test/chunk"):
        os.makedirs("corpus/test/chunk")
        
    for fname in tqdm.tqdm(fnames):
        fpath = os.path.join("/home/cyang314/DtRAG/raw_txt", fname)
        ...
        with open("corpus/test/chunk/{:s}".format(fname.replace(".txt", ".jsonl")), 'w') as f:
            f.write('\n'.join(saved_text))